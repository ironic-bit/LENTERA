...
export function LoginPage() {
  ...
  const demoAccounts = [
    { role: "Admin", desc: "Akses penuh", longDesc: "Memiliki kontrol penuh atas seluruh sistem, termasuk manajemen pengguna, pengaturan aplikasi, dan persetujuan akhir arsip." },
    { role: "User", desc: "View, Create, Edit", longDesc: "Dapat membuat, mengedit, dan mengelola arsip harian. Cocok untuk staf yang menangani dokumen secara langsung." },
    { role: "Viewer", desc: "View only", longDesc: "Hanya dapat melihat dan mencari arsip yang sudah disetujui. Tidak memiliki akses untuk mengubah atau menghapus data." },
  ];
